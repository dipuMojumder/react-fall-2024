...
export function NumberComparator() {
  ...
  return (
    <div className={clsx('w-[50%] h-[85vh] m-[auto] flex flex-col items-center py-6 rounded-md shadow-lg inset-shadow-sm', theme? 'bg-[#222222] text-[#EAEAEA]' : 'bg-[#f7f5f5]' )}>
        ...
        <div className='flex flex-col text-black gap-4 items-center'>
        <input
        className={clsx("border-4 p-2 rounded text-[2vw] ", input1Error ? 'border-red-500' : 'border-gray-300')}
        type="number"
        ...
        />
        <input
        className={clsx("border-4 p-2 rounded text-[2vw] ", input2Error ? 'border-red-500' : 'border-gray-300')}
        type="number"
